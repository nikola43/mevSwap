      ...
      <Nav>
        <Box display="flex" height="full" flexWrap="nowrap">
          <Box className={styles.leftSideContainer}>
            <Box onClick={nativateToSwap} className={styles.logoContainer}>
              <WinterUni width="64px" height="64px" />
            </Box>
            <Box onClick={nativateToSwap} marginRight="10">
              <a style={{ color: 'black', cursor: "pointer" }}>Swap</a>
            </Box>
            <Box onClick={nativateToNFT} marginRight="10">
              <a style={{ color: 'black', cursor: "pointer" }} >NFTs</a>
            </Box>
            {!isNftPage && (
