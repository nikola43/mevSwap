...
const CurrencySelect = styled(ButtonGray) <{
  ...
  color: ${({ selected, theme }) => (selected ? theme.black : theme.black)};
  cursor: pointer;
  height: 36px;
  border-radius: 18px;
  outline: none;
...
const StyledDropDown = styled(DropDown) <{ selected: boolean }>`
  ...
  path {
    stroke: ${({ selected, theme }) => (selected ? theme.neutral1 : theme.black)};
    stroke-width: 2px;
  }
`
          ...
          <InputRow style={hideInput ? { padding: '0', borderRadius: '8px' } : {}}>
            {!hideInput && (
              <div style={{ display: 'flex', flexGrow: 1 }} onClick={handleDisabledNumericalInputClick}>
                <StyledNumericalInput style={{ color: 'black' }}
                ...
                {account ? (
                  <RowFixed style={{ height: '16px' }}>
                    <ThemedText.DeprecatedBody
                      ...
                      fontWeight={485}
                      fontSize={14}
                      style={{ display: 'inline', color: theme.neutral2 }}
                    >
                    ...
                    {showMaxButton && selectedCurrencyBalance ? (
                      ...
                      >
                        <StyledBalanceMax onClick={onMax} style={{ color: theme.neutral2 }}>
                          <Trans>Max</Trans>
                        </StyledBalanceMax>
                      </TraceEvent>
                    ) : null}
